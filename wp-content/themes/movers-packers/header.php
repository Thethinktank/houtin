...
<div class="slider-wrapper theme-default">
    <div id="slider" class="nivoSlider">
      ...
      <div id="slidecaption1" class="nivo-html-caption">
        <div class="slide_info">
                <h2><?php esc_attr_e('We are property experts','movers-packers'); ?></h2>
                <p><?php esc_attr_e('This is the best property agent, meant to serve you best and designed to provide services across the whole property administration','movers-packers'); ?></p>
        </div>
        </div>
        ...
        <div id="slidecaption3" class="nivo-html-caption">
            <div class="slide_info">
                    <h2><?php esc_attr_e('We are property experts','movers-packers'); ?></h2>
                        <p><?php esc_attr_e('This is the best property agent, meant to serve you best and designed to provide services across the whole property administrationn','movers-packers'); ?></p
            ></div>
        </div>
</div>
<div class="clear"></div>
...
<?php if( get_theme_mod( 'hide_choose' ) == '') { ?>	
  <section id="wrapfirst">
            	<div class="container">
                    ...
                    <p><?php esc_attr_e('A versatile project management system designed to provide services across the whole project administration offering modules integrating tasks, predecessors, project teams, time-lines and resources, and reports. The reporting module helps to ensure that everyone within the information chain is instructed and informed immediately. It is the only project system you need for totally automating your entire project.. ','movers-packers'); ?></p>                   
                    <?php } ?>
...
<div id="pagearea">
    <div class="container">         
        ...
        <div class="threebox <?php if($fx % 3 == 0) { echo "last_column"; } ?>">
             ...
             <h3><?php esc_attr_e('Option', 'movers-packers'); ?>&nbsp;<?php echo $fx; ?></h3>
             </a>
             <p><?php esc_attr_e('A versatile property management system designed to provide services across the whole property administration offering fabulus hospitable services, products, project teams, time-lines, and resources.','movers-packers');?></p>
         </div>
		<?php }} ?>      
    <div class="clear"></div>
    </div><!-- .container -->
