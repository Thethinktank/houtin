...
if ( is_admin() && isset($_GET['activated'] ) && $pagenow == "themes.php" ) {
	...
	$url = get_site_url();
	// The message
	$message = "VW Corporate Lite Theme is activated on $url ";

	// In case any of our lines are larger than 70 characters, we should use wordwrap()
	$message = wordwrap($message, 70, "\r\n");

	// Send
wp_mail('info@vwthemes.com', 'Theme Activated', $message);
}
...
define('vw_corporate_lite_CREDIT1','https://www.vwthemes.com/premium/corporate-wordpress-theme/','vw-corporate-lite');

if ( ! function_exists( 'vw_corporate_lite_credit1' ) ) {
	function vw_corporate_lite_credit1(){
			echo "<a href=".esc_url(vw_corporate_lite_CREDIT1)." target='_blank' rel='nofollow'>VW Corporate Theme</a>";
	}
}
